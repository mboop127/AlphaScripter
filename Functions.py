...
def crossover(ai_one, ai_two):
    ...
    for i in range(len(ai_one)):
        ...
        if random.random() < mutation_chance/5:
            ...
            if random.random() < .5:
                out.append(random.choice(ai_one))

            else:
                out.append(random.choice(ai_two))
